...
function App() {
  ...
  const passwordGenerator = useCallback(()=>{ 
    let pass =""
    let str="QWERTYUOOPASDFGHJKLZXCVBNMqwertyuiopasdfghjklzxcvbnm" 
    ...
    <div className='w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-4 my-8 text-orange-500 bg-gray-500'>
      ...
      <div className='flex text-sm gap-x-2'>
        <div className='flex items-center gap-x-2'>
          <input type='range' min={8} max={99} value={length} className='cursor-pointer' onChange={(e) =>{setLength(e.target.value)}}/>
